 ...
 */
@Controller
public class SystemDicationaryController {
    @Autowired
    private ISystemDictionaryService systemDictionaryService;
    @RequestMapping("/systemDictionary_list")
    public String systemDicationaryPage(@ModelAttribute("qo") SystemDictionaryQueryObject qo, Model model){
    ...
    @ResponseBody
    public AjaxResult update(SystemDictionary dictionary){
